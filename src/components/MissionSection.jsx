import { HandHeart, Moon, MapPin, ShieldCheck } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-1 gap-16">
        ...
        <div className="bg-[#222222] p-8 rounded-2xl border border-[#2A2A2A] shadow-lg">
          ...
          <p className="text-[#A1A1AA] mb-6 leading-relaxed">
            If you are aware of a Masjid, organization, hostel, or food
            provider offering Sehri or Iftar, we encourage you to register
            them on this platform with accurate and verified information.
          </p>
          ...
          <div className="flex items-start gap-3 text-sm text-red-400">
            ...
            <p>
              ...
              verified. Misleading or false entries may cause inconvenience
              to those relying on this service.
            </p>
          </div>
        </div>
